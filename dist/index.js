...
var useSwipe = function (target, options) {
    ...
    var ms = 1000 / fps;
    var _f = React.useState(INITIAL_STATE), swipeState = _f[0], setSwipeState = _f[1];
    var targetRef = React.useRef(null);
    var startPositionRef = React.useRef([0, 0]);
    var blocking = false;
    ...
    var onTouchMove = React.useCallback(function (_a) {
    ...
    var throttledOnTouchMove = React.useMemo(function () { return throttle_1(onTouchMove, ms); }, [onTouchMove, ms]);
    var onTouchStart = React.useCallback(function (_a) {
    ...
    var throttledOnTouchStart = React.useMemo(function () { return throttle_1(onTouchStart, ms); }, [onTouchStart, ms]);
    ...
    var removeEventListenerBundle = React.useCallback(function () {
        if (element) {
    ...
    return React.useMemo(function () { return swipeState; }, [swipeState.x, swipeState.y]);
};
